...
4. **Update Architecture**: Update the corresponding `claude.md` file in `architecture/` with the new learning (e.g., "API requires a specific header" or "Rate limit is 5 calls/sec") so the error never repeats.
